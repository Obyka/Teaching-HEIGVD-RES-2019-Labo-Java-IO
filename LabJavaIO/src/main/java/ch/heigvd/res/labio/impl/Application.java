...
public class Application implements IApplication {
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
            ...
            // On initialise un nom de fichier dans le répertoire de travail
            String filename = WORKSPACE_DIRECTORY + "/";
            ...
            for (String tag : quote.getTags()) {
                // On ajoute chaque tag au chemin final pour chaque citation
                filename += tag + "/";
                LOG.info("> " + tag);
            }
            // Le nom du fichier final est concatené à la hierarchie de dossiers.
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        // On s'assure que la hierarchie parente du fichier existe
        f.getParentFile().mkdirs();
        f.createNewFile();
        // On écrit la citation dans le fichier.
        FileUtils.write(f, quote.getQuote());
    }
